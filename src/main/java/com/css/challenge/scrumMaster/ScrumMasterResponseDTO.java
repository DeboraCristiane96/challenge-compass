...
public record ScrumMasterResponseDTO (String name, String email, String emailCompass, String cpf,
    ...
    public ScrumMasterResponseDTO(@NotNull ScrumMaster scrumMaster){
        this(scrumMaster.getName(), scrumMaster.getEmail(), scrumMaster.getEmailCompass(),
